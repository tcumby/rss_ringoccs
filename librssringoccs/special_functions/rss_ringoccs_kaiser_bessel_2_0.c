...
float RSS_RINGOCCS_EXPORT rssringoccs_Float_Kaiser_Bessel_2_0(float x, float W)
{
    float bessel_x, arg;
    arg = 2.0*x/W;
    arg = 1.0 - arg*arg;
...
double RSS_RINGOCCS_EXPORT rssringoccs_Double_Kaiser_Bessel_2_0(double x, double W)
{
    double bessel_x, arg;
    arg = 2.0*x/W;
    arg = 1.0 - arg*arg;
