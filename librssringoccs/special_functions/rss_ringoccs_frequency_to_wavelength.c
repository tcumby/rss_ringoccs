...
RSS_RINGOCCS_EXPORT float rssringoccs_Float_Frequency_To_Wavelength(float frequency)
{
    /*  The conversion is the speed of light divided by the input frequency.  */
    return rssringoccs_Speed_Of_Light_KMS_F / frequency;
}

RSS_RINGOCCS_EXPORT double rssringoccs_Double_Frequency_To_Wavelength(double frequency)
{
    /*  The conversion is the speed of light divided by the input frequency.  */
