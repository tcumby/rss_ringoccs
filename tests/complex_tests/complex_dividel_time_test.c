...
static rssringoccs_ComplexLongDouble rss_div(rssringoccs_ComplexLongDouble w0)
{
    return rssringoccs_CLDouble_Divide(w, w0);
}

/*  Routine for testing rssringoccs_CLDouble_Divide.                          */
int main(void)
{
    ...
    rssringoccs_Compare_CLDouble_Funcs("rss_ringoccs", rss_div,
                                       "C99", div, start, end, N);
 ...
 *          -std=c99 complexl_divide_time_test.c -o test -lrssringoccs        *
 *              -lrssringoccs_compare                                         *
 *  Output (iMac 2017 3.4 GHz Intel Quad-Core i5):                            *
 *      rss_ringoccs: 6.911071                                                *
 *      C99: 11.742171                                                        *
 *      Max Error: 0.000000000000000000121217                                 *
 *  With -O3 optimization:                                                    *
 *      rss_ringoccs: 5.663027                                                *
 *      C99: 11.416603                                                        *
 *      Max Error: 0.000000000000000000121217                                 *
 ******************************************************************************/
