...
/*  C99 version.                                                              */
static double dist(rssringoccs_ComplexDouble z0)
{
    return cabs(z - z0);
}

/*  rss_ringoccs version.                                                     */
static double rss_dist(rssringoccs_ComplexDouble w0)
{
    return rssringoccs_CDouble_Dist(w, w0);
}

/*  Routine for testing rssringoccs_CDouble_Dist.                             */
int main(void)
{
    ...
    rssringoccs_Compare_Real_CDouble_Funcs("rss_ringoccs", rss_dist,
 ...
 *      rss_ringoccs: 1.483403                                                *
 *      C99: 1.006446                                                         *
 *      Max Error: 0.0000000000000000                                         *
 *  With -O3 optimization:                                                    *
 *      rss_ringoccs: 1.345795                                                *
 *      C99: 0.828336                                                         *
 *      Max Error: 0.0000000000000000                                         *
 ******************************************************************************/
