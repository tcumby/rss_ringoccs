...
/*  Routine for testing rssringoccs_CDouble_Abs.                              */
int main(void)
{
    ...
    auto cabs = [](rssringoccs_ComplexDouble z) { return std::abs(z); };
#endif
