...
/*  Routine for testing rssringoccs_CDouble_Erfc.                             */
int main(void)
{
 ...
 *          -std=c99 complex_erfc_time_test.c -o test -lrssringoccs           *
 *              -lrssringoccs_compare -lcerf                                  *
 *      Don't forget to link libcerf as well!                                 *
 *  Output (iMac 2017 3.4 GHz Intel Quad-Core i5):                            *
 *      rss_ringoccs: 1.320064                                                *
 *      libcerf: 1.486391                                                     *
 *      Max Relative Error: 0.0000000000000000                                *
 *  With -O3 optimization:                                                    *
 *      rss_ringoccs: 1.315562                                                *
 *      libcerf: 1.095919                                                     *
 *      Max Relative Error: 0.0000000000000000                                *
 ******************************************************************************/
