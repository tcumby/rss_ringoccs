...
static rssringoccs_ComplexDouble rss_div(rssringoccs_ComplexDouble w0)
{
    return rssringoccs_CDouble_Divide(w, w0);
}

/*  Routine for testing rssringoccs_CDouble_Divide.                           */
int main(void)
{
    ...
    rssringoccs_Compare_CDouble_Funcs("rss_ringoccs", rss_div,
                                      "C99", div, start, end, N);
 ...
 *          -std=c99 complex_divide_time_test.c -o test -lrssringoccs         *
 *              -lrssringoccs_compare                                         *
 *  Output (iMac 2017 3.4 GHz Intel Quad-Core i5):                            *
 *      rss_ringoccs: 3.047275                                                *
 *      C99: 3.598789                                                         *
 *      Max Error: 0.0000000000000002                                         *
 *  With -O3 optimization:                                                    *
 *      rss_ringoccs: 2.555642                                                *
 *      C99: 3.051205                                                         *
 *      Max Error: 0.0000000000000002                                         *
 ******************************************************************************/
