...
/*  Routine for testing rssringoccs_CDouble_Argument.                         */
int main(void)
{
    ...
    auto carg = [](rssringoccs_ComplexDouble z) { return std::arg(z); };
#endif
 ...
 *          -std=c99 complex_argument_time_test.c -o test -lrssringoccs       *
 *              -lrssringoccs_compare                                         *
 *  Output (iMac 2017 3.4 GHz Intel Quad-Core i5):                            *
 *      rss_ringoccs: 1.894431                                                *
 *      C99: 1.922015                                                         *
 *      Max Error: 0.0000000000000000                                         *
 *  With -O3 optimization:                                                    *
 *      rss_ringoccs: 1.905609                                                *
 *      C99: 1.937082                                                         *
 *      Max Error: 0.0000000000000000                                         *
 ******************************************************************************/
