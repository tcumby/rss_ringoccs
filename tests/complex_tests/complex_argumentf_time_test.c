...
/*  Routine for testing rssringoccs_CFloat_Argument.                          */
int main(void)
{
    ...
    auto cargf = [](rssringoccs_ComplexFloat z) { return std::arg(z); };
#endif
 ...
 *          -std=c99 complex_argumentf_time_test.c -o test -lrssringoccs      *
 *              -lrssringoccs_compare                                         *
 *  Output (iMac 2017 3.4 GHz Intel Quad-Core i5):                            *
 *      rss_ringoccs: 2.091128                                                *
 *      C99: 2.718659                                                         *
 *      Max Error: 0.00000024                                                 *
 *  With -O3 optimization:                                                    *
 *      rss_ringoccs: 2.113779                                                *
 *      C99: 2.671937                                                         *
 *      Max Error: 0.00000024                                                 *
 ******************************************************************************/
