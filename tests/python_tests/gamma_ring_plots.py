...
rece = rss_ringoccs.diffrec.DiffractionCorrection(
    datau, 0.05, psitype="ellipse", ecc=0.0, peri=0.0, rng=rng, res_factor=1.0
)
plt.subplot(611)
...
rece = rss_ringoccs.diffrec.DiffractionCorrection(
    datau, 0.05, psitype="ellipse", ecc=1.09e-4, peri=peri, rng=rng, res_factor=1.0
)
plt.subplot(612)
...
rece = rss_ringoccs.diffrec.DiffractionCorrection(
    datau, 0.05, psitype="ellipse", ecc=1.09e-3, peri=peri, rng=rng, res_factor=1.0
)
plt.subplot(613)
...
rece = rss_ringoccs.diffrec.DiffractionCorrection(
    datau, 0.05, psitype="ellipse", ecc=1.09e-5, peri=peri, rng=rng, res_factor=1.0
)
plt.subplot(614)
...
rece = rss_ringoccs.diffrec.DiffractionCorrection(
    datau, 0.05, psitype="newtond", rng=rng, res_factor=1.0
)
plt.subplot(615)
...
rece = rss_ringoccs.diffrec.DiffractionCorrection(
    datau, 0.05, psitype="newton", rng=rng, res_factor=1.0
)
plt.subplot(616)
