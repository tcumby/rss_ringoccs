...
int main(void)
{
    ...
    rssringoccs_Compare_Float_Funcs("C99", fabsf,
                                    "rss_ringoccs", rssringoccs_Float_Abs,
                                    start, end, N);
