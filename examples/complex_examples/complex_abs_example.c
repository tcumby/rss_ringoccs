...
int main(void)
{
    ...
    for (n=0; n<7; ++n)
    {
        ...
        w[n] = rssringoccs_CDouble_Abs(z[n]);
 ...
 *                                                                            *
 *      gcc complex_abs_example.c -o test -lrssringoccs                       *
 *                                                                            *
 ...
 *              complex_abs_example.c -o test -lrssringoccs                   *
 *                                                                            *
 ...
 *          -Wpedantic complex_abs_example.c -o test -lrssringoccs            *
 *                                                                            *
